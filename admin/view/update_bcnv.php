    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="">
                <div class="">
                    <div class="card">
                        <form class="form-horizontal" action="index.php?act=update_bcnv" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="id_pro" class="form-control" placeholder="Mã chuyên ngành (auto)" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="tennvien" class="col-sm-3 text-right control-label col-form-label">Tên bằng cấp</label>
                                    <div class="col-sm-9">
                                       <input type="text"  class="form-control" placeholder="Tên bằng cấp">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control"  placeholder="VD: Trường đại học X" >
